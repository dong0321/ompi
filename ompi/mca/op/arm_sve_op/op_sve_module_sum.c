...
/** @file
 *
 * This is the sum module source code.  It contains
 ...
 * cache some module-specific information for SUM.  Note that
...
/**
 * "Constructor" for the sum module class
 */
...
/**
 * "Destructor" for the sum module class
 */
                       ...
                       ompi_datatype_t **type, ompi_op_base_module_t *module)
{
    ...
    opal_output(0, "In sve sum double function");
...
{
    module_sum_t *m = (module_sum_t*) module;
    opal_output(0, "In sve sum double precision function");
 ...
 */
ompi_op_base_module_t *ompi_op_sve_sum(ompi_op_t *op)
{
    ...
    if (mca_op_sve_component.double_supported) {
        /* C double */
        module->super.opm_fns[OMPI_OP_BASE_TYPE_DOUBLE] = sum_double;
