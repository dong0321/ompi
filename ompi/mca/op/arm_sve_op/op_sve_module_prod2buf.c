...
/** @file
 *
 * This is the prod2buf module source code.  It contains
 * functions that will create a module for the MPI_PROD MPI_Op.
 */
 ...
 */
ompi_op_base_module_t *ompi_op_sve_prod2buf(ompi_op_t *op)
{
