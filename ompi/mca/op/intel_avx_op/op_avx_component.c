...
/** @file
 *
 * This is the "avx" component source code.  It contains the
                                        ...
                                        bool enable_mpi_thread_multiple)
{
    ...
    */
    ...
    /* Note that we used MCA parameters to fill in the
       ...
       are only used in this avx to allow simulating different
       types of hardware). */
    ...
    avx_component_op_query(struct ompi_op_t *op, int *priority)
{
    ...
    /* What follows is an avx of how to determine whether your
       component supports the queried MPI_Op.  You can do this lots of
       different ways; this is but one avx. */
